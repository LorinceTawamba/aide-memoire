...
### A REORGANISER 
 ...
 - **Java**
    ...
    - **Medium.** https://medium.com/ 
        - **JPA vs Hibernate vs Spring Data JPA.** https://levelup.gitconnected.com/jpa-vs-hibernate-vs-spring-data-jpa-63433dcaa6b9 
        - **How to Create Custom Annotations in Spring Boot for Cleaner Code.** https://medium.com/@mahesh.babu11/how-to-create-custom-annotations-in-spring-boot-for-cleaner-code-5067f969d5ba
        - **Using DTO (Data Transfer Object) Projection — Mapping Entities to DTOs and vice versa in Java Spring Boot.** https://medium.com/@bectorhimanshu/using-dto-data-transfer-object-projection-mapping-entities-to-dtos-and-vice-versa-in-java-a7a9fe6b50a4 
        - **Java8 Stream API.** https://blog.devops.dev/java8-stream-api-613f66c87b2c 
        - **Spring Boot File Upload/Download/Delete.** https://blog.devops.dev/spring-boot-file-upload-download-delete-94982145bea0 
        - **Generate DTOs and Mappers with JPA Buddy & MapStruct in Intellij IDEA.** https://medium.com/@islamboulila/generate-dtos-and-mappers-with-jpa-buddy-mapstruct-in-intellij-idea-e6c5414e0d9e
        - **Spring Security Basic Authentication with Database and Unit Testing.** https://medium.com/@sehgal.mohit06/spring-security-basic-authentication-with-database-and-unit-testing-f40420d094f6 
        ...
        - **Relationships.** 
            - **Java Spring Boot — Relationships.** https://medium.com/@zubeyrdamar/java-spring-boot-one-to-one-rel-7eae27c8b1d6 
